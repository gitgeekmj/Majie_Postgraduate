...
public class BookComend extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    return new PostgraduateFragment();
                case 1:
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    String SECTION_1 = getResources().getString(R.string.bookCommend_one);
                    return SECTION_1;
                case 1:
                    String SECTION_2 = getResources().getString(R.string.bookCommend_two);
                    return SECTION_2;
                case 2:
                    String SECTION_3 = getResources().getString(R.string.bookCommend_three);
                    return SECTION_3;
            }
            return null;
        }
